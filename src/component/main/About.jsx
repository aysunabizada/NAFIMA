    ...
    return (
        <main className="bg-[#31304D] text-white">
            <section className="relative py-4">
                <div data-aos="fade-down" data-aos-duration="1500" className="lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:items-start lg:gap-24">
                                    ...
                                    <blockquote className="mt-8">
                                        <div className="relative text-lg font-normal text-white md:flex-grow">
                                            ...
                                            <p className="relative">
                                                "Silence hides violence." <br />
                                                – Səssizlik zorakılığı gizlədir. <br />
                                                <p className='text-right'>"Speak up, even if your voice shakes." <br />
                                                — Səsin titrəsə belə danış, susma.</p>
                                            </p>
                                        </div>
                                    </blockquote>
                                </div>
